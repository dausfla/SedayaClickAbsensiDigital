...
INSERT INTO `attendances` (`id`, `user_id`, `attendance_date`, `clock_in_time`, `clock_in_photo`, `clock_in_lat`, `clock_in_lng`, `clock_in_note`, `clock_out_time`, `clock_out_photo`, `clock_out_lat`, `clock_out_lng`, `clock_out_note`, `work_duration_seconds`, `late_duration_seconds`, `overtime_seconds`, `status`, `created_at`, `updated_at`, `overtime_clock_in_time`, `overtime_clock_out_time`, `overtime_clock_in_photo`, `overtime_clock_out_photo`, `overtime_clock_in_lat`, `overtime_clock_in_lng`, `overtime_clock_out_lat`, `overtime_clock_out_lng`, `overtime_task_reason`, `overtime_clock_in_note`, `overtime_clock_out_note`, `overtime_duration_seconds`, `overtime_status`, `overtime_review_note`, `overtime_reviewed_by`, `overtime_reviewed_at`) VALUES
...
('3pA1gm6DiChAk_zKXQcs0x0Dt-zPCL8T', 1790283653, '{\"cookie\":{\"originalMaxAge\":43200000,\"expires\":\"2026-09-24T20:59:07.307Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":5,\"full_name\":\"Super Admin\",\"email\":\"admin@gmail.com\",\"role\":\"super_admin\",\"status\":\"active\",\"division_id\":null,\"division_name\":null,\"position_name\":null}}'),
('4IXcYxug_27yxvF8rfHs-b7Kf-k057ZT', 1790263659, '{\"cookie\":{\"originalMaxAge\":43200000,\"expires\":\"2026-09-24T14:51:05.734Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":12,\"full_name\":\"Adit\",\"email\":\"adit@gmail.com\",\"role\":\"admin_manager\",\"status\":\"active\",\"division_id\":1,\"division_name\":\"Head Office\",\"position_name\":\"Manager\"}}'),
('MKkQNxv0zymFh5ls-r7fjWkmZoRmQRur', 1790257327, '{\"cookie\":{\"originalMaxAge\":43200000,\"expires\":\"2026-09-24T02:00:39.520Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":13,\"full_name\":\"daus\",\"email\":\"daus@gmail.com\",\"role\":\"employee\",\"status\":\"active\",\"division_id\":4,\"division_name\":\"IT\",\"position_name\":\"Manager\"}}'),
('b2Mmo2eW2ju02QnKH61dfcUEyZh335GS', 1792764895, '{\"cookie\":{\"originalMaxAge\":2592000000,\"expires\":\"2026-10-23T05:13:12.620Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":5,\"full_name\":\"Super Admin\",\"email\":\"admin@gmail.com\",\"role\":\"super_admin\",\"status\":\"active\",\"division_id\":null,\"division_name\":null,\"position_name\":null}}'),
('gCZ5anT6jCDEv8Z8YCGv8xXuuHCQ2NfN', 1790266229, '{\"cookie\":{\"originalMaxAge\":43200000,\"expires\":\"2026-09-24T14:02:31.053Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":12,\"full_name\":\"Adit\",\"email\":\"adit@gmail.com\",\"role\":\"admin_manager\",\"status\":\"active\",\"division_id\":1,\"division_name\":\"Head Office\",\"position_name\":\"Manager\"}}'),
('lnzPJ0DDHmVtXTLRZCf2JpmWnZ0sWMou', 1790259050, '{\"cookie\":{\"originalMaxAge\":43200000,\"expires\":\"2026-09-24T13:53:24.386Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":13,\"full_name\":\"daus\",\"email\":\"daus@gmail.com\",\"role\":\"employee\",\"status\":\"active\",\"division_id\":4,\"division_name\":\"IT\",\"position_name\":\"Manager\"}}'),
('wyWqLdFLAtXZUE8bDUjnnXrIkSBWhkc6', 1792813203, '{\"cookie\":{\"originalMaxAge\":2592000000,\"expires\":\"2026-10-24T03:39:17.766Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"user\":{\"id\":12,\"full_name\":\"Adit\",\"email\":\"adit@gmail.com\",\"role\":\"admin_manager\",\"status\":\"active\",\"division_id\":1,\"division_name\":\"Head Office\",\"position_name\":\"Manager\"}}');
...
INSERT INTO `shift_settings` (`id`, `name`, `start_time`, `end_time`, `tolerance_minutes`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `submissions` (`id`, `user_id`, `type`, `start_date`, `end_date`, `start_time`, `end_time`, `reason`, `attachment`, `status`, `reviewed_by`, `review_note`, `reviewed_at`, `created_at`, `updated_at`, `handover_plan`, `handover_to_name`, `handover_to_position`) VALUES
...
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `whatsapp`, `address`, `division_id`, `position_id`, `shift_id`, `role`, `status`, `photo_profile`, `created_at`, `updated_at`) VALUES
...
--
-- Stand-in structure for view `view_attendance_report`
-- (See below for the actual view)
--
CREATE TABLE `view_attendance_report` (
...
,`work_duration_hms` time
,`late_duration_hms` time
,`overtime_hms` time
,`status` enum('on_time','late','early_leave','incomplete')
,`clock_in_note` text
,`clock_out_note` text
);
...
--
-- Stand-in structure for view `view_submission_report`
-- (See below for the actual view)
--
CREATE TABLE `view_submission_report` (
`submission_id` int(11)
,`user_id` int(11)
,`full_name` varchar(150)
,`division_name` varchar(100)
,`type` enum('izin','cuti','sakit','lembur')
,`start_date` date
,`end_date` date
,`total_days` int(8)
...
--
DROP TABLE IF EXISTS `view_attendance_report`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_attendance_report`  AS SELECT `a`.`id` AS `attendance_id`, `u`.`id` AS `user_id`, `u`.`full_name` AS `full_name`, `d`.`name` AS `division_name`, `p`.`name` AS `position_name`, `a`.`attendance_date` AS `attendance_date`, `a`.`clock_in_time` AS `clock_in_time`, `a`.`clock_out_time` AS `clock_out_time`, sec_to_time(ifnull(`a`.`work_duration_seconds`,0)) AS `work_duration_hms`, sec_to_time(ifnull(`a`.`late_duration_seconds`,0)) AS `late_duration_hms`, sec_to_time(ifnull(`a`.`overtime_seconds`,0)) AS `overtime_hms`, `a`.`status` AS `status`, `a`.`clock_in_note` AS `clock_in_note`, `a`.`clock_out_note` AS `clock_out_note` FROM (((`attendances` `a` join `users` `u` on(`u`.`id` = `a`.`user_id`)) left join `divisions` `d` on(`d`.`id` = `u`.`division_id`)) left join `positions` `p` on(`p`.`id` = `u`.`position_id`)) ;
...
--
DROP TABLE IF EXISTS `view_submission_report`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_submission_report`  AS SELECT `s`.`id` AS `submission_id`, `u`.`id` AS `user_id`, `u`.`full_name` AS `full_name`, `d`.`name` AS `division_name`, `s`.`type` AS `type`, `s`.`start_date` AS `start_date`, `s`.`end_date` AS `end_date`, to_days(`s`.`end_date`) - to_days(`s`.`start_date`) + 1 AS `total_days`, `s`.`status` AS `status`, `s`.`reason` AS `reason`, `reviewer`.`full_name` AS `reviewed_by_name`, `s`.`reviewed_at` AS `reviewed_at` FROM (((`submissions` `s` join `users` `u` on(`u`.`id` = `s`.`user_id`)) left join `divisions` `d` on(`d`.`id` = `u`.`division_id`)) left join `users` `reviewer` on(`reviewer`.`id` = `s`.`reviewed_by`)) ;
...
ALTER TABLE `attendances`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_user_date` (`user_id`,`attendance_date`);
